...
#import "PopAlertWebView.h"
#import <QuartzCore/QuartzCore.h> 

@interface PopAlertWebView (Private)
...
@implementation PopAlertWebView

//@synthesize delegate;

#pragma mark - PopAlertWebView Life Circle
...
- (id)init
{
    if (self = [super initWithFrame:CGRectMake(0, 0, 320, 480)])
    {
        ...
        closeBtn.frame=CGRectMake(280-10, 0, 20, 20);
